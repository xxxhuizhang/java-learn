...
//        final Map<Object, Object> map1 = Collections.synchronizedMap();
...
//        final Set<Object> set1 = Collections.synchronizedSet();
        Set<String> set = new CopyOnWriteArraySet<>(); //CopyOnWriteArraySet 底层为 new CopyOnWriteArrayList<E>();
        for (int i = 1; i <= 30; i++) {
            new Thread(() -> {
