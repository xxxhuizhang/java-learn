...
//		singleLinkedList.add(hero3);
        ...
        /*
         * //加入按照编号的顺序 singleLinkedList.addByOrder(hero1);
         * singleLinkedList.addByOrder(hero4); singleLinkedList.addByOrder(hero2);
         * singleLinkedList.addByOrder(hero3);
         *
         ...
         * System.out.println("删除后的链表情况~~"); singleLinkedList.list();
         *
         * //测试一下 求单链表中有效节点的个数 System.out.println("有效的节点个数=" +
         * getLength(singleLinkedList.getHead()));//2
         *
         * //测试一下看看是否得到了倒数第K个节点 HeroNode res =
         * findLastIndexNode(singleLinkedList.getHead(), 3); System.out.println("res=" +
         * res);
         */
    ...
    //方法：查找链表的中间结点
    public HeroNode findMidNode(HeroNode head) {
    ...
    //方法：判断单链表是否有环
    public boolean hasCycle(HeroNode head) {
